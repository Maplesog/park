...
THREE.Water = function ( width, height, options ) {
        ...
        var normalMap0 = options.normalMap0 || textureLoader.load( 'source/Water_1_M_Normal.jpg' );
        var normalMap1 = options.normalMap1 || textureLoader.load( 'source/Water_2_M_Normal.jpg' );
